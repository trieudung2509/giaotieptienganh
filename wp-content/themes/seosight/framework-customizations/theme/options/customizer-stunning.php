...
$options = array(
	'stunning-show' => array(
		...
		'picker'  => array(
			'value' => array(
				'label'        => esc_html__( 'Stunning Header Section', 'seosight' ),
				'type'         => 'switch',
				'left-choice'  => array(
					'value' => 'no',
	...
	'stunning_hide_title'   => array(
		'type'  => 'switch',
		'label' => esc_html__( 'Page Title', 'seosight' ),
		'desc'  => esc_html__( 'You can control visibility of this element', 'seosight' ),
		'left-choice' => array(
			'value' => 'yes',
			'label' => esc_html__( 'Hide', 'seosight' )
		),
	...
	'stunning_hide_breadcrumbs'   => array(
		'type'  => 'switch',
		'label' => esc_html__( 'Breadcrumbs', 'seosight' ),
		'desc'  => esc_html__( 'You can control visibility of this element', 'seosight' ),
		'left-choice' => array(
			'value' => 'yes',
			'label' => esc_html__( 'Hide', 'seosight' )
