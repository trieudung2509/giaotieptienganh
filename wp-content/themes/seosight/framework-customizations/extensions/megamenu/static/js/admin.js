jQuery( function ( $ ) {
    ...
    ( function ( selector ) {
        ...
        $( document ).on( 'click', selector, function () {
            var checkbox = $( this );
            if( checkbox.hasClass('csf--active') ){
                checkbox.closest( '.menu-item' ).find( '.mega-menu-title' ).prop( 'readonly', true );
            } else {
                checkbox.closest( '.menu-item' ).find( '.mega-menu-title' ).prop( 'readonly', false );
            }
        } );
    } )( '.seosight-menu-column-field.hide-title .csf--switcher' );
    ...
    ( function () {
        ...
        function update()
        {
            ...
            menu.children( '.menu-item-depth-0:has(.seosight-menu-mega-enable input:checked)' ).each( function () {
                var item = $( this );
        ...
        $( document ).on( 'change', '.menu-item-depth-0 .seosight-menu-mega-enable input', update );
