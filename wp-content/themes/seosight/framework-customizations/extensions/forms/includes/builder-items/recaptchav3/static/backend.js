fw.shortcodesLoadData().then(function ( response ) {
    fwEvents.on('fw-builder:'+ 'form-builder' +':register-items', function(builder){
      var currentItemType = 'recaptcha_v3';
      ...
      var ItemView = builder.classes.ItemView.extend({
        ...
        render: function () {
          this.defaultRender({
            ...
            site_key: fw.opg('recaptcha_v3/site-key', this.model.get('options'))
              ? fw.opg('recaptcha_v3/site-key', this.model.get('options'))
              : localized.l10n.site_key,
            secret_key: fw.opg('recaptcha_v3/secret-key', this.model.get('options'))
              ? fw.opg('recaptcha_v3/secret-key', this.model.get('options'))
