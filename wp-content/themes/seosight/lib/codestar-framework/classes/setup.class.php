  ...
  class CSF {
    ...
    public static function add_admin_enqueue_scripts() {
      ...
      if ( apply_filters( 'csf_fa4', false ) ) {
        ...
        $cdn = esc_url('//cdn.'.'jsdelivr.net/');
        wp_enqueue_style( 'csf-fa5', $cdn . 'npm/@fortawesome/fontawesome-free@5.15.3/css/all'. $min .'.css', array(), '5.15.3', 'all' );
        wp_enqueue_style( 'csf-fa5-v4-shims', $cdn . 'npm/@fortawesome/fontawesome-free@5.15.3/css/v4-shims'. $min .'.css', array(), '5.15.3', 'all' );
      }
